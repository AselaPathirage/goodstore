                        ...
                        <div class="products-list row list">
                            <table border="1" cellpadding="3">
                                ...
                                <tr>
                                            ...
                                            <div class="product-item-container">
                                                <div class="left-block">
                                                    <div class="product-image-container lazy second_img ">
                                                        <img data-src="{{asset('storage/vehicleimg/'.$vehicle->productimg1)}}" src="{{asset('storage/vehicleimg/'.$vehicle->productimg1)}}" alt="Apple Cinema 30&quot;" class="img-responsive" />
                                                        <img data-src="{{asset('storage/vehicleimg/'.$vehicle->productimg2)}}" src="{{asset('storage/vehicleimg/'.$vehicle->productimg2)}}" alt="Apple Cinema 30&quot;" class="img_0 img-responsive" />
                                                    </div>
                                                    <!--Sale Label-->

                                                    <!--full quick view block-->
                                                    <a class="quickview iframe-link visible-lg" data-fancybox-type="iframe" href="/vehicle/vehiclequickview/{{$vehicle->id}}"> Quickview</a>
                                                ...
                                                <div class="right-block">
                                                    <div class="caption">
                                                        <h4><a href="/vehicle/vehiclequickview/{{$vehicle->id}}">{{$vehicle->title}}&quot;</a></h4>
                                                        <div class="ratings">
                                                            <p>Created at: {{$vehicle->created_at}}</p>
                                                        </div>

                                                        <div class="price">
                                                            <span class="price-new">Rs. {{$vehicle->price}}</span>
                                                            @if ($vehicle->negotiable==true){
                                    ...
                                    <td>
                                        <div class="reward"><span>ClientId: </span> {{$vehicle->userid}} </div>
                                        <div class="reward"><span>Client name: </span> {{$vehicle->name}} </div>
                                        <div class="reward"><span>Client email: </span> {{$vehicle->email}} </div>

                                    </td>
                                    <td>

                                        <a href="vehicleapp/{{$vehicle->id}}">Approve</a>
                                    </td>
                                    <td>

                                        <a href="vehicledel/{{$vehicle->id}}">Delete</a>
                                    </td>
                                <tr>
                                    @endforeach
                            </table>
